...
class AddProductControllerTest extends WebTestCase
{
    ...
    {
        $this->client->request('POST', '/cart/5bd88887-7017-4c08-83de-8b5d9abde58c/00e91390-3af8-4735-bd06-0311e7131757');
        self::assertResponseStatusCodeSame(422);

        $response = $this->getJsonResponse();
        self::assertEquals([
            'error_message' => 'Card 5bd88887-7017-4c08-83de-8b5d9abde58c is full',
        ], $response);
    ...
    {
        $this->client->request('POST', '/cart/8e9efe09-3f5b-4681-9f6a-adb4a5a9f19c/00e91390-3af8-4735-bd06-0311e7131757');
        self::assertResponseStatusCodeSame(404);
    }

    public function testReturns404IfProductDoesNotExist(): void
    {
        $this->client->request('POST', '/cart/5bd88887-7017-4c08-83de-8b5d9abde58c/b832e983-6159-47db-a98f-575a46d9544c');
        self::assertResponseStatusCodeSame(404);
    }
}
