...
class AddProductControllerFixture extends AbstractFixture
{
    public function load(ObjectManager $manager): void
    {
        $products = [
            ...
            new Product('00e91390-3af8-4735-bd06-0311e7131757', 'Product 4', 5990,4),
        ];
        ...
        $fullCart = new ProductCart('1e82de36-23f3-4ae7-ad5d-616295f1d6c0');
        $fullCart->setCart($cart);
        $fullCart->setProduct($products[0]);
        $fullCart->setProduct($products[1]);
        $fullCart->setProduct($products[2]);
        $fullCart->setProduct($products[3]);
